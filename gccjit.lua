...
function export.debug_string(obj)
   return ffi.string(libgccjit.gcc_jit_get_debug_string(obj))
end
...
function Context:set_option(option, value)
    ...
    if type(value) == "boolean" then --use gcc_jit_context_set_bool_option
        libgccjit.gcc_jit_context_set_bool_option(self, libgccjit["GCC_JIT_BOOL_OPTION_"..option], value)
    elseif type(value) == "number" then --use gcc_jit_context_set_int_option
        libgccjit.gcc_jit_context_set_int_option(self, libgccjit["GCC_JIT_INT_OPTION_"..option], value)
    else --use gcc_jit_context_set_str_option
        libgccjit.gcc_jit_context_set_str_option(self, libgccjit["GCC_JIT_STR_OPTION_"..option], value)
    end
end
...
function Context:get_type(tname)
